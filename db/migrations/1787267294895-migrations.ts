...
export class Migrations1787267294895 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "ag_members" ("id" BIGSERIAL NOT NULL, "organization_id" text NOT NULL, "agency_id" bigint NOT NULL, "user_id" text NOT NULL, "full_name" text NOT NULL, "license_id" text NOT NULL, "role" "public"."ag_members_role_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_fe7b7c25716b2371ff63bf5232a" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "biz_payments" ("id" BIGSERIAL NOT NULL, "agency_id" bigint NOT NULL, "subscription_id" bigint, "promotion_id" bigint, "currency" text NOT NULL, "amount" numeric(14,2) NOT NULL, "purpose" "public"."biz_payments_purpose_enum" NOT NULL, "status" "public"."biz_payments_status_enum" NOT NULL, "provider" "public"."biz_payments_provider_enum" NOT NULL, "provider_ref" text, "payment_method" text, "failure_reason" text, "paid_at" TIMESTAMP WITH TIME ZONE, "refunded_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_1a9846aebcd4a74a082b98ae665" UNIQUE ("provider_ref"), CONSTRAINT "PK_aa15cc98605ae8f08964a37da6a" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "ag_prop_feature_lists" ("id" BIGSERIAL NOT NULL, "property_id" bigint NOT NULL, "feature_type" "public"."ag_prop_feature_lists_feature_type_enum" NOT NULL DEFAULT 'OTHER_FEATURES', "name" text, "description" text, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_bb0004e060e6c10076e82301ed0" PRIMARY KEY ("id"))`);
